  ...
  },
  {
    ...
    earnRates: [
      ...
      },
      {
        ...
        rewardType: "CASHBACK",
        rateMultiplier: 0.5,
        description: "0.5% CT Money on all other purchases",
        mccTags: ["general"],
        locationScope: "WORLDWIDE",
      },
    ],
    caps: ["1.5% grocery rate on first $12,000 annual grocery spend"],
    keyBenefits: [
  ...
  },
  {
    ...
    earnRates: [
      ...
      },
      {
        ...
        rewardType: "CASHBACK",
        rateMultiplier: 2,
        description: "2% on other gas stations and Costco.ca purchases",
